/** Sentinel row at end of picker — never persist this string as `vet_name`; use manual input instead. */
export const VET_NOT_LISTED_OPTION = "Not listed - enter manually" as const;
